	          ...
	          "children": [
	            {
	              "type": "text",
	              "attr": {
	                "value": function () {return (this.video.video_name) + (this.videosrc)}
	              },
	              "classList": [
	                "title"
	              ],
	              "events": {
	                "click": function (evt) {this.routePush('Index',{},evt)}
	              }
	            },
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wxDiscode = __webpack_require__(10);
	...
	var _system11 = $app_require$('@app-module/system.clipboard');
	...
	module.exports = {
	    ...
	    onInit: function onInit() {
	        var me = this;
	        var uid = me.user_id;
	        var vid = me.vid || 99610697;
	        var aid = me.aid || 9454627;
	        me.uid = uid;
	        me.vid = vid;
	        me.aid = aid;
	        console.log(me.vid);
	    ...
	    getRecomList: function getRecomList(albumld) {
	        var me = this;
	        _system6.default.fetch({
	            url: _common2.default.api_uri + '/v4/search/recommend.json?site=2&vid=' + me.vid + '&aid=' + albumld + '&plat=17&api_key=f351515304020cad28c92f70f002261c&sver=6.2&partner=78&poid=1',
	            success: function success(res) {
	    ...
	    loadAlbumList: function loadAlbumList(albumId, page, vid, callback) {
	        ...
	        this.frozen = true;
	        var that = this;
	        var url = _common2.default.api_uri + '/v4/album/videos/' + albumId + '.json?page_size=' + that.albumPageSize + '&with_trailer=1&with_fee_video=3&prevideo_rule=2&order=1&vid=' + vid + '&plat=17&api_key=f351515304020cad28c92f70f002261c&sver=6.2&partner=78&poid=1';
	        if (page && page > 1) {
	            url = _common2.default.api_uri + '/v4/album/videos/' + albumId + '.json?page_size=' + that.albumPageSize + '&page=' + (page == null ? 1 : page) + '&with_trailer=1&with_fee_video=3&prevideo_rule=2&order=1&plat=17&api_key=f351515304020cad28c92f70f002261c&sver=6.2&partner=78&poid=1';
	        }
	        _system6.default.fetch({
	            url: url,
	            success: function success(res) {
	    ...
	    getPlayInfo: function getPlayInfo(vid, callback) {
	        ...
	        _system6.default.fetch({
	            ...
	            success: function success(res) {
	                ...
	                video.keyword = video.keyword.trim() ? video.keyword.split(" ") : [];
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  ".comment-content .floor-box > view": {
	    "paddingTop": "6px",
	    "paddingBottom": "4px",
	    "_meta": {
	      "ruleDef": [
	  ...
	  ".comment-content .floor-box > view .head": {
	    "color": "#a6a6a6",
	    "fontSize": "26px",
	    "display": "flex",
	    "alignItems": "center",
	  ...
	  ".comment-content .floor-box > view .head .f-num": {
	    "fontSize": "22px",
	    "_meta": {
	      "ruleDef": [
	        {
